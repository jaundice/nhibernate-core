...
namespace NHibernateClient.Engine
{
    /// <summary>
    ...
    public sealed class QueryParameters
    {
        ...
        //[DataMember] internal static readonly ILogger log = LoggerProvider.LoggerFor(typeof (QueryParameters));

        //[DataMember] internal IType[] _positionalParameterTypes;
        [DataMember] internal object[] _positionalParameterValues;
        [DataMember] internal int[] _positionalParameterLocations;
        //[DataMember] internal IDictionary<string, TypedValue> _namedParameters;
        [DataMember] internal IDictionary<string, LockMode> _lockModes;
        //[DataMember] internal IList<IType> filteredParameterTypes;
        [DataMember] internal IList<object> filteredParameterValues;
        [DataMember] internal IList<int> filteredParameterLocations;
        [DataMember] internal RowSelection _rowSelection;
        [DataMember] internal bool _cacheable;
        [DataMember] internal string _cacheRegion;
        [DataMember] internal object[] _collectionKeys;
        [DataMember] internal object _optionalObject;
        [DataMember] internal string _optionalEntityName;
        [DataMember] internal object _optionalId;
        [DataMember] internal string _comment;
        [DataMember] internal bool _readOnly;
        [DataMember] internal int? limitParameterIndex = null;
        [DataMember] internal int? offsetParameterIndex = null;
        [DataMember] internal int wildcardSubqueryLimitParameterIndex = -1;
        [DataMember] internal IDictionary<int, int> _adjustedParameterLocations;
        [DataMember] internal IDictionary<int, int> _tempPagingParameterIndexes;
        [DataMember] internal IDictionary<int, int> _pagingParameterIndexMap;

        //[DataMember] internal SqlString processedSQL;

        [DataMember] internal IResultTransformer _resultTransformer;
        // not implemented: [DataMember] internal ScrollMode _scrollMode;
        ...
        public QueryParameters( /*IType[] positionalParameterTypes,*/
            object[] postionalParameterValues, object optionalObject,
        ...
        public QueryParameters( /*IType[] positionalParameterTypes,*/ object[] postionalParameterValues)
            : this( /*positionalParameterTypes,*/
                postionalParameterValues, null, null, false, null, null, false, null, null)
        {
        }
        ...
        public QueryParameters( /*IType[] positionalParameterTypes,*/ object[] postionalParameterValues,
            ...
            : this(
                ...
                postionalParameterValues, /*namedParameters,*/ null, null, false, false, null, null,
                collectionKeys, null)
        {
        }
        ...
        //[DataMember] internal void CreatePositionalParameterLocations(ISessionFactoryImplementor factory)
        //{
        ...
        //[DataMember] internal IList<Parameter> FindParametersIn(SqlString sqlString)
        //{
        ...
        //[DataMember] internal SqlType[] ConvertITypesToSqlTypes(List<IType> nhTypes, ISessionFactoryImplementor factory, int totalSpan)
        //{
