...
namespace NHibernateClient.Engine.Query
{
    ...
    public class ParameterMetadata
    {
        ...
        [DataMember] internal OrdinalParameterDescriptor[] ordinalDescriptors;
        [DataMember] internal Dictionary<string, NamedParameterDescriptor> namedDescriptorMap;
    ...
    {
        public QueryParameterException(string s) : base(s)
        {
        }
    }
}