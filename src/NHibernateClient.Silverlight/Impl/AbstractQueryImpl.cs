...
using NHibernateClient.Engine.Query;
...
namespace NHibernateClient.Impl
{
    ...
    {
        [DataMember] internal string queryString;
        //[DataMember] internal ISessionImplementor session;
        protected internal ParameterMetadata parameterMetadata;

        [DataMember] internal RowSelection selection;
        [DataMember] internal List<object> values = new List<object>(4);
        //[DataMember] internal List<IType> types = new List<IType>(4);
        //[DataMember] internal Dictionary<string, TypedValue> namedParameters = new Dictionary<string, TypedValue>(4);
        //protected readonly Dictionary<string, TypedValue> namedParameterLists = new Dictionary<string, TypedValue>(4);
        [DataMember] internal bool cacheable;
        [DataMember] internal string cacheRegion;
        [DataMember] internal bool readOnly;
        [DataMember] internal static readonly object UNSET_PARAMETER = new object();
        //[DataMember] internal static readonly IType UNSET_TYPE = null;
        [DataMember] internal object optionalId;
        [DataMember] internal object optionalObject;
        [DataMember] internal string optionalEntityName;
        //[DataMember] internal FlushMode flushMode = FlushMode.Unspecified;
        //[DataMember] internal FlushMode sessionFlushMode = FlushMode.Unspecified;
        [DataMember] internal object collectionKey;
        [DataMember] internal IResultTransformer resultTransformer;
        [DataMember] internal bool shouldIgnoredUnknownNamedParameters;
        //[DataMember] internal CacheMode? cacheMode;
        //[DataMember] internal CacheMode? sessionCacheMode;
        [DataMember] internal string comment;

        protected AbstractQueryImpl(string queryString,
        ...
        ///// </exception>
        //[DataMember] internal IType GuessType(object param)
        //{
        //    if (param == null)
        //    {
        ...
        ///// </exception>
        //[DataMember] internal IType GuessType(System.Type clazz)
        //{
        //    if (clazz == null)
        //    {
        ...
        ///// Warning: adds new parameters to the argument by side-effect, as well as mutating the query string!
        ///// </summary>
        //[DataMember] internal string ExpandParameterList(string query, string name, TypedValue typedList, IDictionary<string, TypedValue> namedParamsCopy)
        //{
        ...
        private void CheckPositionalParameter(int position)
        {
            ...
            {
                throw new ArgumentException("Positional parameter does not exist: " + position + " in query: " +
                                            QueryString);
            }
        }
        ...
        {
            get { return ArrayHelper.ToStringArray(parameterMetadata.NamedParameterNames); }
        }
    ...
    internal class NonUniqueResultException : Exception
    {
        public NonUniqueResultException(int size)
        {
    ...
    {
        public QueryException(string s, string queryString)
            : base(string.Format("{0} : {1}", s, queryString))
        {
        }
    }
}