...
namespace NHibernateClient.Criterion
{
    ...
    public class Projections
    {
        ...
        /// <param name="columnAliases"></param>
        /// <returns></returns>
        public static IProjection SqlProjection(string sql, string[] columnAliases)
        {
            return new SQLProjection(sql, columnAliases);
        }
        ...
        /// <param name="columnAliases"></param>
        /// <returns></returns>
        public static IProjection SqlGroupProjection(string sql, string groupBy, string[] columnAliases)
        {
            return new SQLProjection(sql, groupBy, columnAliases);
        }
