...
namespace NHibernateClient.Criterion
{
	...
	public sealed class SQLProjection : IProjection
	{
        ...
        [DataMember]
        internal readonly string groupBy;
        ...
        [DataMember]
        internal readonly bool grouped;
        ...
        internal SQLProjection(string sql, string[] columnAliases)
            : this(sql, null, columnAliases)
        {
        }

        internal SQLProjection(string sql, string groupBy, string[] columnAliases)
        {
            this.sql = sql;
            //this.types = types;
            this.aliases = columnAliases;
