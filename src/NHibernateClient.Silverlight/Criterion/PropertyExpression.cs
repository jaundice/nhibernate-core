...
namespace NHibernateClient.Criterion
{
    ...
    public abstract class PropertyExpression : AbstractCriterion
    {
        ...
        [DataMember(Name = "LHSPropertyName")]
        internal string _lhsPropertyName;
        [DataMember(Name = "RHSPropertyName")]
        internal string _rhsPropertyName;
        [DataMember(Name = "LHSProjection")]
        internal IProjection _lhsProjection;
        [DataMember(Name = "RHSProjection")]
        internal IProjection _rhsProjection;
