...
{
    public class QueryOverLockBuilder<TRoot, TSubType> :
        QueryOverLockBuilderBase<QueryOver<TRoot, TSubType>, TRoot, TSubType>
    {
    ...
    public class IQueryOverLockBuilder<TRoot, TSubType> :
        QueryOverLockBuilderBase<IQueryOver<TRoot, TSubType>, TRoot, TSubType>
    {
