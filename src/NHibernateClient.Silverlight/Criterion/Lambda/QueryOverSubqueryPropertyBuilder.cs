...
{
    public class QueryOverSubqueryPropertyBuilder<TRoot, TSubType> :
        QueryOverSubqueryPropertyBuilderBase<QueryOver<TRoot, TSubType>, TRoot, TSubType>
    {
    ...
    public class IQueryOverSubqueryPropertyBuilder<TRoot, TSubType> :
        QueryOverSubqueryPropertyBuilderBase<IQueryOver<TRoot, TSubType>, TRoot, TSubType>
    {
