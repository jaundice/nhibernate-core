...
namespace NHibernateClient.Criterion.Lambda
{
    ...
    public class QueryOverSubqueryBuilder<TRoot, TSubType> :
        QueryOverSubqueryBuilderBase
            <QueryOver<TRoot, TSubType>, TRoot, TSubType, QueryOverSubqueryPropertyBuilder<TRoot, TSubType>>
    {
    ...
    [Serializable]
    [DataContract(IsReference = true)]
    public class IQueryOverSubqueryBuilder<TRoot, TSubType> :
        QueryOverSubqueryBuilderBase
            <IQueryOver<TRoot, TSubType>, TRoot, TSubType, IQueryOverSubqueryPropertyBuilder<TRoot, TSubType>>
    {
        ...
        where TBuilderType : QueryOverSubqueryPropertyBuilderBase, new()
    {
        ...
        {
            AbstractCriterion criterion = ExpressionProcessor.ProcessSubquery<TSubType>(LambdaSubqueryType.Exact,
                                                                                        expression);
            root.And(criterion);
            return root;
        }
        ...
        {
            AbstractCriterion criterion = ExpressionProcessor.ProcessSubquery<TSubType>(LambdaSubqueryType.All,
                                                                                        expression);
            root.And(criterion);
            return root;
        }
        ...
        {
            AbstractCriterion criterion = ExpressionProcessor.ProcessSubquery<TSubType>(LambdaSubqueryType.Some,
                                                                                        expression);
            root.And(criterion);
            return root;
        }
