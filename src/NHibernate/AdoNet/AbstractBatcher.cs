...
namespace NHibernate.AdoNet
{
	...
	public abstract class AbstractBatcher : IBatcher
	{
		...
		private readonly Iesi.Collections.Generic.ISet<IDbCommand> _commandsToClose = new HashedSet<IDbCommand>();
		private readonly Iesi.Collections.Generic.ISet<IDataReader> _readersToClose = new HashedSet<IDataReader>();
