...
namespace NHibernate.Test.NHSpecificTest.NH1810
{
	...
	public class ChildrenBehaviour : IChildrenBehaviour
	{
		...
		public ChildrenBehaviour(Iesi.Collections.Generic.ISet<Child> children)
		{
	...
	public class Children : Iesi.Collections.Generic.SortedSet<Child>, IChildren
	{
	...
	public class PersistentChildren : PersistentGenericSet<Child>, IChildren
	{
		...
		public PersistentChildren(ISessionImplementor session, Iesi.Collections.Generic.ISet<Child> collection)
	...
	public class Factory : SetFactory<Child>
	{
		...
		{
			return new PersistentChildren(session, (Iesi.Collections.Generic.ISet<Child>)collection);
		}
	...
	public class SetFactory<T> : IUserCollectionType
	{
		...
		{
			return ((Iesi.Collections.Generic.ISet<T>)collection).Contains((T)entity);
		}

		public object IndexOf(object collection, object entity)
		{
			return new List<T>((Iesi.Collections.Generic.ISet<T>)collection).IndexOf((T)entity);
		}

		public object ReplaceElements(object original, object target, ICollectionPersister persister, object owner, IDictionary copyCache, ISessionImplementor session)
		{
			var result = (Iesi.Collections.Generic.ISet<T>)target;
			result.Clear();
